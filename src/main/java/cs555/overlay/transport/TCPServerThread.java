...
/**
 * Class to encapsulate a server socket, which will be
 * available to connect to at every node instance in the
 * system.
 *
 * @author hayne
 */
public class TCPServerThread implements Runnable {
    ...
    /**
     * Loops over ServerSocket while it is non-null. Accepts
     * connections when available, and creates new TCPConnections
     * with active TCPReceiverThreads for those new connections.
     */
    @Override
    public void run() {
