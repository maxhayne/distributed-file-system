...
public class ControllerSendsClientValidChunkServers implements Event {

	public String filename;
	public int sequence;
	public String[] servers; // Will be in format 'IP:PORT'

	public ControllerSendsClientValidChunkServers(String filename, int sequence, String[] servers) {
	...
	public byte[] getBytes() throws IOException {
		...
		dout.writeByte(Protocol.CONTROLLER_SENDS_CLIENT_VALID_CHUNK_SERVERS);
