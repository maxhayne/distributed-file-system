...
public class ChunkServerDeniesRequest implements Event {

	public String filename;

	public ChunkServerDeniesRequest(String filename) {
	...
	public byte[] getBytes() throws IOException {
		...
		dout.writeByte(Protocol.CHUNK_SERVER_DENIES_REQUEST);
